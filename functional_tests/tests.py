...
class NewVisitorTest(LiveServerTestCase):
	...
	def test_can_start_a_list_and_retrieve_it_later(self):
		...
		# page lists "1: Buy peacock feathers" as an item in a 
		# to-do list
		...
		# item. She enters "Use peacock feathers to make a fly" 
		...
		# list. Then she sees that the site has generated a 
		# unique URL for her -- there is some explanatory text 
		# to that effect.
